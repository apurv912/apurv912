...
Technical PM with an engineering background (B.Tech ECE + HHL MBA). 
Shipped a GenAI + RAG banner tool at Amazon. Built 0→1 products from 
Leipzig to India. Currently building PR OS — an India-first PR workflow 
system for agencies.
...
**Connect:** [LinkedIn](https://linkedin.com/in/apurv-adarsh) | apurvadarsh3483@gmail.com
